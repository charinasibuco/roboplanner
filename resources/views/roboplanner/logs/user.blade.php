...
@section('title', $user->full_name . ' Logs')
@section('styles')
                ...
                <div class="panel panel-default bootstrap-admin-no-table-panel">
                    ...
                    <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <form method="get" action="{{ route('user_logs',$user->id)}}">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        @if(Auth::user()->id != $row->id)
                                                            <li>
                                                                <a title="Delete Log of {{ $row->user->full_name  }}" href = "{{ route('delete_log_from_user', $row->id) }}" class="delete_confirmation">
...
@section('scripts')
    ...
    <script>
        ...
        $('.delete_confirmation').on('click',function(){
            var x = confirm('Are you sure you want to delete the logs for this User?');
